...
fn main() {
    ...
    // Spark Block Engine
    let is_connected_to_spark_block_engine = Arc::new(AtomicBool::new(false));
    ...
    let spark_block_engine_forwarder = SparkBlockEngineRelayerHandler::new(
    ...
    let jito_block_engine_forwarder = JitoBlockEngineRelayerHandler::new(
